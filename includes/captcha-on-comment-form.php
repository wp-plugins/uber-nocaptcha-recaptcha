 ...
 *
     * Because we're using is_user_logged_in which is a pluggable function and gets triggered only after the plugins are loaded
     * we needed to hook onto to the init function and run our class only after the core has completely loaded.
     *
...
class ncr_captcha_on_comment_form extends ncr_base_class {
     ...
     */
        public function __construct() {
            ...
            add_filter( 'comment_form_defaults', array($this, 'uncr_display_captcha_comment_form'), 10, 2);
